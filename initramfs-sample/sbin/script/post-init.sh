...
if [ -f /system/bin/customboot.sh ]; then
  echo "/system/bin/customboot.sh"
  $b sh /system/bin/customboot.sh;
fi;

if [ -f /system/xbin/customboot.sh ]; then
  echo "/system/xbin/customboot.sh"
  $b sh /system/xbin/customboot.sh
fi;

if [ -f /data/local/customboot.sh ]; then
  echo "/data/local/customboot.sh"
  $b sh /data/local/customboot.sh
fi;
) &
